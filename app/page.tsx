      ...
      <main>
        <section className="hero section-pad">
          <div className="hero-copy">
            ...
            <div className="button-row">
              ...
              <a className="secondary-button" href="/poetry">Read my poetry <span aria-hidden="true">↗</span></a>
            </div>
          </div>
        </section>
        ...
        {featuredProjects.length ? <section className="work-section section-pad">
          <div className="section-heading">
            ...
            <a className="text-link" href="/projects">See all projects <span aria-hidden="true">→</span></a>
          </div>
        ...
        <section className="poetry-feature section-pad">
          <div className="poetry-intro"><p className="eyebrow">A quieter room</p><h2>Poetry lives here, too.</h2><p>Alongside the systems and screens, I write to notice what code can’t quite hold.</p><a className="text-link" href="/poetry">Enter the poetry room <span aria-hidden="true">→</span></a></div>
          {featuredPoem ? (
            <a className="poem-card" href={`/poetry/${featuredPoem.slug}`}>
        ...
        <section className="about-strip section-pad">
          ...
          <div><p className="eyebrow">A little about me</p><h2>Engineering gives ideas structure. Writing gives them breath.</h2><p>I study Computer Science and Economics at UC Berkeley. I’m interested in products where technology, behavior, and culture meet—and in helping other people find confidence in difficult ideas.</p><a className="secondary-button" href="/about">More about me <span aria-hidden="true">→</span></a></div>
        </section>
      </main>
      <SiteFooter />
    </div>
